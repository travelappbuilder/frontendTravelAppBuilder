...
const SidebarCf: React.FC<Props> = ({ setActiveContent }) => {
  const [isOpen, setIsOpen] = useState(false);

  const menuItems = [
    { id: "home", label: "Tableau de bord", icon: <FaHome /> },
    { id: "trajets", label: "Mes trajets", icon: <FaRoute /> },
    { id: "visualisation", label: "Position Actuelle du trajet", icon: <FaEye /> },
    ...
    <>
      ...
      >
        ...
        <div className="p-6 text-center border-b border-gray-700">
          <h2 className="text-xl font-bold">Menu Chauffeur</h2>
        </div>

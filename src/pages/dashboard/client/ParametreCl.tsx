...
const ParametreCl: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log("Données personnel stockées :", storedPersonnel);

    if (storedPersonnel) {
      const cl = JSON.parse(storedPersonnel);

      // Sécurité : vérifier que c'est bien un client
      if (cl.roleUtilisateur === "ROLE_CLIENT") {
        setPersonnelData(cl);
        setFormData({
          nomUtilisateur: cl.nomUtilisateur || "",
          prenomUtilisateur: cl.prenomUtilisateur || "",
          emailUtilisateur: cl.emailUtilisateur || "",
          telephoneUtilisateur: cl.telephoneUtilisateur || "",
          motDePasseUtilisateur: cl.motDePasseUtilisateur || "",
          photoProfilUtilisateur: cl.photoProfilUtilisateur || null,
        });
      }
    }
  }, []);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedPersonnel = {
      ...
      motDePasseUtilisateur: formData.motDePasseUtilisateur || personnelData.motDePasseUtilisateur,
